...
* A detailed look at the Cumbrian spending data is covered in xref:cumbria_spends_i.adoc[Cumbria Spends : Database Import], xref:cumbria_spends_i.adoc[Cumbria Spends : Aggregation & Review]
