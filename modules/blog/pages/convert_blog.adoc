...
image::antora3.png[align="left"]

* The `modules` directory contains the `.adoc` documents. I think it _may_
 be required to be called modules.

image::antora4.png[align="left"]

* This is where I decided how I was going to structure the content, I decided to keep
 all the converted blog posts in one directory.
* I decided to hcreate a documents directory for other material in the first instance,
 I may need to revisit this at some point.
* The `ROOT` directory is a feature you can use in Antora, ROOT is a special key word that
...
image::antora5.png[align="left"]

* In each 'ROOT', 'blog' and 'docs' directory I created the above directories
* These were the locations of the content files, content types are described below
